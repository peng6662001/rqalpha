...
OUTPUT = REPO_ROOT / ".temp" / "low_volatility_rebalance_frequency.json"
...
def with_env(params: dict):
    keys = list(BASE_ENV) + ["RQALPHA_LOW_VOL_REBALANCE_FREQUENCY"]
    old_env = {key: os.environ.get(key) for key in keys}
    os.environ.update(BASE_ENV)
    os.environ["RQALPHA_LOW_VOL_REBALANCE_FREQUENCY"] = params["rebalance_frequency"]
    return old_env
