...
def init(context):
    ...
    context.target = "159949.XSHE"
    context.market_peak = 0.0
    context.entry_drawdown = 0.03
    context.reset_drawdown = 0.02
    context.wait_for_reset = False
    context.armed_for_entry = False
    context.position_peak_price = 0.0
    context.trailing_activation_profit = 0.35
    context.trailing_stop_drawdown = 0.12
    context.trailing_exit_drawdown = 0.18
