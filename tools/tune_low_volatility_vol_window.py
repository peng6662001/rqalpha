...
OUTPUT = REPO_ROOT / ".temp" / "low_volatility_vol_window.json"
...
def with_env(params: dict):
    keys = list(BASE_ENV) + ["RQALPHA_LOW_VOL_VOL_WINDOW"]
    old_env = {key: os.environ.get(key) for key in keys}
    os.environ.update(BASE_ENV)
    os.environ["RQALPHA_LOW_VOL_VOL_WINDOW"] = str(params["vol_window"])
    return old_env
