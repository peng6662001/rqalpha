...
def init(context):
    ...
    context.entry_drawdown = 0.06
    context.reset_drawdown = 0.03
    context.wait_for_reset = False
    context.armed_for_entry = False
    context.position_peak_price = 0.0
    context.trailing_activation_profit = 0.20
    context.trailing_stop_drawdown = 0.08
    context.trailing_exit_drawdown = 0.12
    ...
    if profit is not None:
        ...
        if (
            ...
            if trailing_drawdown >= context.trailing_exit_drawdown:
                ...
                target_percent = min(target_percent, 0.30)
                logger.info(
