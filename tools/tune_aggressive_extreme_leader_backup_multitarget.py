...
OUTPUT = REPO_ROOT / ".temp" / "tune_aggressive_extreme_leader_backup_multitarget.json"
...
def main():
    ...
    variants = [
        ("dual_base", {}),
        ("tri_159915", {"RQALPHA_TERTIARY": "159915.XSHE"}),
        ("tri_512000", {"RQALPHA_TERTIARY": "512000.XSHG"}),
        ("tri_512880", {"RQALPHA_TERTIARY": "512880.XSHG"}),
        ("tri_513100", {"RQALPHA_TERTIARY": "513100.XSHG"}),
        ("tri_159915_fast_switch", {"RQALPHA_TERTIARY": "159915.XSHE", "RQALPHA_SWITCH_DELTA": 0.01}),
        ("tri_512000_fast_switch", {"RQALPHA_TERTIARY": "512000.XSHG", "RQALPHA_SWITCH_DELTA": 0.01}),
        ("tri_512880_fast_switch", {"RQALPHA_TERTIARY": "512880.XSHG", "RQALPHA_SWITCH_DELTA": 0.01}),
        ("tri_159915_look15", {"RQALPHA_TERTIARY": "159915.XSHE", "RQALPHA_LOOKBACK": 15}),
        ("tri_512000_look15", {"RQALPHA_TERTIARY": "512000.XSHG", "RQALPHA_LOOKBACK": 15}),
    ]
