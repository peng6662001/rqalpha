...
from ss_common import BENCHMARK, close_history, run_monthly_selection, setup_context, total_return
...
def score_stock(context, order_book_id):
    ...
    benchmark = close_history(BENCHMARK, 60)
    if prices is None or benchmark is None:
        return None
    return total_return(prices) - total_return(benchmark)
